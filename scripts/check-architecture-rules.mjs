...
async function main() {
  ...
  if (
    ...
    !locationTokenContents.includes("LOCATION_RESOLUTION_TOKEN_VERSION = 4") ||
    !locationTokenContents.includes("actorBindingHash")
  ) {
    violations.push(
      "Location token v4 must bind the actor plus both 20m and 100m cells",
    );
  }
