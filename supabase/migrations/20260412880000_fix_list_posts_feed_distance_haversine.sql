-- Restore accurate distance calculation in list_posts_feed.
-- Previous changes switched to bucket-space Euclidean distance, which can drift
-- from real-world distance. Use haversine over stored coordinates instead.
