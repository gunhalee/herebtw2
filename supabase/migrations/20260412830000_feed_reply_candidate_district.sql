-- Feed: 이전 접근 방식(local_council_district, council_type 반환)을 area_code_prefix 방식으로 대체.
-- 20260412750000_feed_district_reply_sort.sql에서 정의한 함수가 최종 버전이므로
-- 해당 시그니처와 일치하도록 함수를 재생성.
